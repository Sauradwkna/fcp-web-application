...
func (u *sessionsRepo) SessionAvailEmail(email string) (model.Session, error) {
	mail, err := u.filebasedDb.SessionAvailEmail(email)
	if err != nil {
		return model.Session{}, err
	}
	return mail, nil // TODO: replace this
}

func (u *sessionsRepo) SessionAvailToken(token string) (model.Session, error) {
	tokens, err := u.filebasedDb.SessionAvailToken(token)
	if err != nil {
		return model.Session{}, err
	}
	return tokens, nil // TODO: replace this
}
